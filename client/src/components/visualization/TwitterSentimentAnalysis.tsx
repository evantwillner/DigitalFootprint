...
interface TwitterSentimentAnalysisProps {
  platformData: PlatformData;
  isLoading?: boolean;
}

export function TwitterSentimentAnalysis({ platformData, isLoading }: TwitterSentimentAnalysisProps) {
  if (isLoading) {
    return (
      <Card className="mb-8">
    ...
    <Card className="bg-white rounded-lg overflow-hidden mb-8">
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold mb-4 flex items-center">
          <SiX className="mr-2 text-[#000000]" />
          Twitter/X Sentiment Analysis
        </h3>
        
        <p className="text-gray-600 mb-6">
          This analysis examines the emotional tone of your tweets and interactions:
        </p>
